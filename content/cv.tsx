...
export const CV = {
  ...
  //   },
  // ],
  personal: `I post videos on YouTube and code on GitHub. I enjoy creating content, working out, reading, and research in my free time. Please feel free to contact me with any project ideas you may have. I hope you enjoy looking through my portfolio, and I look forward to the chance to work with you on your next projects. Let us create amazing things! It is also important to me to keep up with web technology and UX design developments by listening to podcasts, attending local events, attending conferences, and using Twitter.`,
};
